...
/***/ function(module, exports, __webpack_require__) {
	...
	var View = BaseView.extend({
	  ...
	  renderPage: function () {
	    // 组件一，编辑背景图片
	    var EditBgView = __webpack_require__(51);
	    // 组件二，主播信息
	    var InfoView = __webpack_require__(58);
	    // 组件三，主播控制消息
	    var ChatView = __webpack_require__(61);
	    // 公告组件
	    var NoticeView = __webpack_require__(74);
	    // 直播开始,结束控制
	    var LiveShowBtnView = __webpack_require__(78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var base = __webpack_require__(18);
	var BaseView = base.View; // View的基类
	var EditBgModel = __webpack_require__(52);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var View = BaseView.extend({
	  ...
	  // 当模板挂载到元素之前
	  beforeMount: function () {
	    this.infoTpl = __webpack_require__(60);
	  },
	  // 当模板挂载到元素之后
	  afterMount: function () {
	    var el = this.$el;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoticeModel = __webpack_require__(75);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var uiConfirm = __webpack_require__(45);
	var msgBox = __webpack_require__(56);
	var StartLiveModel = __webpack_require__(79);
	var EndLiveModel = __webpack_require__(80);
	var FlashApi = __webpack_require__(63);
	var UserModel = __webpack_require__(34);
	var user = UserModel.sharedInstanceUserModel();
	var BusinessDate = __webpack_require__(62);
