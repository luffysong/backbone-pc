...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	  var MainView = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var imServer = __webpack_require__(32);
	...
	var RoomDetailModel = __webpack_require__(48);
	var RoomLongPollingModel = __webpack_require__(49);
	var GiftModel = __webpack_require__(50);
	var PermissionModel = __webpack_require__(51);
	...
	var View = BaseView.extend({
	  ...
	  renderPage: function () {
	    // 组件一，编辑背景图片
	    var EditBgView = __webpack_require__(52);
	    // 组件二，主播信息
	    var InfoView = __webpack_require__(59);
	    // 组件三，主播控制消息
	    var ChatView = __webpack_require__(62);
	    // 公告组件
	    var NoticeView = __webpack_require__(75);
	    // 直播开始,结束控制
	    var LiveShowBtnView = __webpack_require__(79);
	
	    var AssistantView = __webpack_require__(83);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var base = __webpack_require__(18);
	var BaseView = base.View; // View的基类
	var EditBgModel = __webpack_require__(53);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var View = BaseView.extend({
	  ...
	  // 当模板挂载到元素之前
	  beforeMount: function () {
	    this.infoTpl = __webpack_require__(61);
	  },
	  // 当模板挂载到元素之后
	  afterMount: function () {
	    var el = this.$el;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FlashApi = __webpack_require__(64);
	...
	// 清屏,锁屏
	var RoomControlView = __webpack_require__(65);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FieldControlView = __webpack_require__(66);
	
	var imServer = __webpack_require__(32);
	var uiConfirm = __webpack_require__(45);
	var msgBox = __webpack_require__(57);
	var uiDialog = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserModel = __webpack_require__(35);
	var user = UserModel.sharedInstanceUserModel();
	var RoomManagerListModel = __webpack_require__(67);
	var RoomManagerAddModel = __webpack_require__(68);
	var RoomManagerRemoveModel = __webpack_require__(69);
	...
	var View = BaseView.extend({
	  ...
	  findElements: function () {
	    ...
	    this.itemTpl = __webpack_require__(70);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoticeModel = __webpack_require__(76);
	var NoticeGetModel = __webpack_require__(77);
	var imServer = __webpack_require__(32);
	var UserModel = __webpack_require__(35);
	var user = UserModel.sharedInstanceUserModel();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var uiConfirm = __webpack_require__(45);
	var msgBox = __webpack_require__(57);
	var StartLiveModel = __webpack_require__(80);
	var EndLiveModel = __webpack_require__(81);
	var FlashApi = __webpack_require__(64);
	var UserModel = __webpack_require__(35);
	var user = UserModel.sharedInstanceUserModel();
	var BusinessDate = __webpack_require__(63);
