...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	  ...
	  var MainView = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserModel = __webpack_require__(52);
	var user = UserModel.sharedInstanceUserModel();
	var RoomLongPollingModel = __webpack_require__(204);
	var IMModel = __webpack_require__(50);
	var imModel = IMModel.sharedInstanceIMModel();
	var YYTIMServer = __webpack_require__(49);
	var AnchorUserInfoModel = __webpack_require__(70);
	var UserInfo = __webpack_require__(69);
	var InAndOurRoomModel = __webpack_require__(205);
	var ChannelDetailModel = __webpack_require__(206);
	var LiveVideoListModel = __webpack_require__(207);
	...
	var View = BaseView.extend({
	  ...
	  renderPage: function () {
	    ...
	    var LiveVideoListView = __webpack_require__(222);
	    var type = {
	      type: 'channel',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var View = BaseView.extend({
	  ...
	  beforeMount: function () {
	    //  初始化一些自定义属性
	    this.itemTpl = __webpack_require__(223);
	  },
	  afterMount: function () {
	    //  获取findDOMNode DOM Node
	  },
